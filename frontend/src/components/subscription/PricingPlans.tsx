          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {Object.entries(plans).map(([key, plan]) => {
              ...
              return (
                <div
                  key={planName}
                  className={`relative bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 ${planName === 'Pro' ? 'ring-2 ring-teal-500 md:scale-105' : ''
                    }`}
                >
                  {/* Recommended Badge */}
                  {planName === 'Pro' && (
                  ...
                  <div className="p-6">
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-lg font-semibold transition-all duration-200 flex items-center justify-center gap-2 transform hover:scale-105 ${isCurrentPlan
